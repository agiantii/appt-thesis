\begin{cuzchapter}{系统设计与实现}{chap:design}
    ...
    Slidev主题表存储平台可用的主题配置，
    通过npm包名标识每个主题，系统根据npm包名拉取对应npm包加载到系统，
    如slidev-theme-meetup@1.5.3，
    它的npm包名为slidev-theme-meetup@1.5.3，
    主题名称为slidev-theme-meetup，
    而预览图URL用于显示主题的风格和样式，帮助用户挑选自己喜欢的主题。
    % 用户创建幻灯片时可从已有主题中选择应用，
    ...
    唯一的区别就是没有预览图URL，因为插件作为功能性的拓展，无法通过预览图片
    详细知道使用效果、如何使用。
