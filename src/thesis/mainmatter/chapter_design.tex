...
\usetikzlibrary{calc}
    ...
    \begin{figure}[htbp]
        ...
        \begin{tikzpicture}[
            ...
            relationship/.style={rectangle, draw, fill=green!10, align=center, minimum width=2.0cm, minimum height=0.9cm, inner sep=0.1cm},
            arrow/.style={->, >=stealth, thick},
    ...
    \begin{figure}[htbp]
        ...
        \node[process, below=of edit, yshift=-0.5cm] (persist) {定期保存到\\后端数据库};
