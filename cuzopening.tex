...
%---------------------------------------------------------------------------%
\documentclass[singlesided,cuzhdr]{styles/cuzopening}%
...
%->> Document settings
%---------------------------------------------------------------------------%
\usepackage{tikz}          % tikz核心包
\usetikzlibrary{shapes, arrows, positioning} % tikz扩展库
...
\cleardoublepage
\nomatter
\input{src/opening/openingbody.tex}
\nomatter
%-> The references
